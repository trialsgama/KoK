...
public class Utilidades {
    ...
    public static final String CREAR_TABLA_MOMENTOS = " CREATE TABLE" + crear_tabla_momento + " (" + campo_nota+ " TEXT," + campo_fecha + " TEXT," + campo_ciudad + " TEXT," + campo_pais + " TEXT," + campo_imagen + " TEXT , " +campo_usuario_momento+" TEXT, FOREIGN KEY (" + campo_usuario_momento + ") REFEREMCES usuarios(" + campo_usuario +"))";
}
